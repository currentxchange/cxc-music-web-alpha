...
<span id="mood-selector" class="labelOne static-selectah">
mood

</span>

<span id="format-selector" class="labelOne static-selectah">
format

</span>

<span id="clear-selectors" class="labelOne static-selectah">
clear all
</span>
